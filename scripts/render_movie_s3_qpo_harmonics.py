"""
Order Creator Mechanism (OCM) - Supplementary Movie S3
Script: render_movie_s3_qpo_harmonics.py
Description: Renders Movie S3 showing X-ray power density spectrum resonances 
             (f_L = 184 Hz, f_U = 276 Hz) and dynamic standing-wave modes 
             along the R_d = 3M boundary shell for XTE J1550-564.
"""
...
# Titles (Strictly Matched to Movie S3)
ax1.set_title("MOVIE S3: High-Frequency QPO Power Density Spectrum\n(XTE J1550-564 Resonant Peaks f_L = 184 Hz & f_U = 276 Hz)", 
              color='#38bdf8', fontsize=10, fontweight='bold', pad=12)
ax2.set_title("MOVIE S3: R_d = 3M Boundary Shell Standing-Wave Acoustics\n(Harmonic Resonances Locked in Strict 3:2 Ratio)", 
...
status_A = fig.text(0.28, 0.08, '', color='#38bdf8', fontsize=8.5, fontweight='bold', ha='center', va='top', 
                      bbox=dict(facecolor='#0d111d', edgecolor='#38bdf8'))
status_B = fig.text(0.72, 0.08, '', color='#f97316', fontsize=8.5, fontweight='bold', ha='center', va='top', 
                      bbox=dict(facecolor='#0d111d', edgecolor='#f97316'))
...
output_filename = 'MovieS3_QPO_Harmonic_Acoustics.mp4'
